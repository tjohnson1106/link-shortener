defmodule Shorten.Ecto.HashId do
    @behaviour Ecto.Type
    @hash_id_length 8
...
"""
@spec cast(any) :: Map.t
def case(value),  do: hash_id_format(value)

@doc """
Converts/accepts a value that has been directly placed into the ecto struct after a changeset
"""
@spec dump(any) :: Map.t
def dump(value), do: hash_id_format(value)

@doc """
Converts a value from the database into the hash id type
"""
@spec load(any) :: Map.t
...
@doc """
validate the given value as string
"""
